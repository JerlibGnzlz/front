            ...
            <main className="flex-1 flex overflow-hidden">
                ...
                <div className="flex-1 flex xl:overflow-hidden">
                  ...
                  <div className="flex-1 max-h-screen xl:overflow-y-auto">
                    <div className="max-w-3xl mx-auto py-10 px-4 sm:px-6 lg:py-12 lg:px-8">
                      ...
                      <Form  onSubmit={handleSubmit} className="mt-6 space-y-8 divide-y divide-y-blue-gray-200">
                        <div className="grid grid-cols-1 gap-y-6 sm:grid-cols-6 sm:gap-x-6">
                          ...
                          <div className="sm:col-span-6">
                            ...
                            <div>
                            {values.image ? (
                            <img src={values?.image}  readOnly className='inline-block h-36 w-36 mt-4 rounded-full' alt="img" />
                              ) : (
              ...
              />
                        ...
                        <div className="pt-8 flex justify-end">
                          ...
                          <button onClick={(e) => backOnClicke(e)}
                            type="button"
