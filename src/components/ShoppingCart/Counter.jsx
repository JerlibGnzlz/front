...
function Counter({ product }) {
  ...
  return (
    <div className="rounded-2xl bg-white box-border w-9/12 h-auto mx-auto pb-8 shadow-2xl dark:text-black dark:bg-gray-400 ">
      <div className="bg-white border-2 border-gray-300/100 rounded-xl m-8 pb-4 dark:bg-gray-300 ">
